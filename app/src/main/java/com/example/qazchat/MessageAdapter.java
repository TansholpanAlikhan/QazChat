...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    private final String imgPath = "https://firebasestorage.googleapis.com/v0/b/qazchat-71447.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=37986fda-0d43-4112-807a-b0c2ee40dc1d";
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder holder, final int position) {
        ...
        if(fromMessageType.equals("text")){
            ...
            if(fromUserID.equals(messageSenderId)){
                holder.messageSenderPicture.setVisibility(View.VISIBLE);
                Picasso.get().load(imgPath).into(holder.messageSenderPicture);
            }
            else{
                holder.receiverProfileImage.setVisibility(View.VISIBLE);
                holder.messageReceiverPicture.setVisibility(View.VISIBLE);
                Picasso.get().load(imgPath).into(holder.messageReceiverPicture);
            }
        }
        if(fromUserID.equals(messageSenderId)){
